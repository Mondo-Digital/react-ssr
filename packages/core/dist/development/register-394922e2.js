...
var _objectWithoutProperties = /*@__PURE__*/unwrapExports(objectWithoutProperties);
...
var map_1 = function (it) {
  var own = it.map;
  return it === ArrayPrototype$5 || (it instanceof Array && own === ArrayPrototype$5.map) ? map$2 : own;
};
...
var _extends = /*@__PURE__*/unwrapExports(_extends_1);
...
var slice_1 = function (it) {
  var own = it.slice;
  return it === ArrayPrototype$2 || (it instanceof Array && own === ArrayPrototype$2.slice) ? slice$5 : own;
};
...
var includes$2 = function (it) {
  var own = it.includes;
  if (it === ArrayPrototype$1 || (it instanceof Array && own === ArrayPrototype$1.includes)) return includes$4;
...
var getPrototypeOf$3 = path.Object.getPrototypeOf;
...
var startsWith_1 = function (it) {
  ...
  return typeof it === 'string' || it === StringPrototype$1
    || (it instanceof String && own === StringPrototype$1.startsWith) ? startsWith$2 : own;
};
...
var endsWith$2 = entryVirtual('String').endsWith;
...
var endsWith_1 = function (it) {
  ...
  return typeof it === 'string' || it === StringPrototype
    || (it instanceof String && own === StringPrototype.endsWith) ? endsWith$2 : own;
};
...
var getSsrConfig = function getSsrConfig() {
  ...
  var ssrConfigPath = path__default['default'].join(cwd$1, 'ssr.config.js');
...
var getEngine = function getEngine() {
  return existsSync(path__default['default'].join(cwd$1, 'tsconfig.json')) ? 'tsx' : 'jsx';
};
    ...
    return regenerator.wrap(function _callee$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return readdir__default['default'](path__default['default'].join(cwd$1, ssrConfig.viewsDir));
...
var getPageId = function getPageId(page) {
  ...
  var _page$replace$replace = page.replace(path__default['default'].join(cwd$1, ssrConfig.viewsDir), '').replace(path__default['default'].extname(page), '').split(path__default['default'].sep),
      _page$replace$replace2 = _toArray(_page$replace$replace),
      rest = slice$3(_page$replace$replace2).call(_page$replace$replace2, 1);
...
var ignoreDotDir = function ignoreDotDir(file, stats) {
  ...
  return stats.isDirectory() && startsWith(_context4 = path__default['default'].basename(file)).call(_context4, '.');
};
    ...
    return regenerator.wrap(function _callee2$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            return _context6.abrupt("return", readdir__default['default'](cwd$1, concat(_context5 = [ignoreNodeModules, ignoreDotDir]).call(_context5, ignores)));
...
require('@babel/register')({
  ...
  plugins: filter(_context = ['babel-plugin-react-require', ['babel-plugin-css-modules-transform', {
    'extensions': ['.css', '.scss']
...
var userDocumentPath = path__default['default'].join(cwd, ssrConfig.viewsDir, "_document".concat(ext));
...
var userAppPath = path__default['default'].join(cwd, ssrConfig.viewsDir, "_app".concat(ext));
var AppComponent;
    ...
    return regenerator.wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _context2.next = 5;
            return Promise.resolve().then(function () { return require('./antd-edd0dce2.js'); });
          ...
          case 7:
            _context2.next = 9;
            return Promise.resolve().then(function () { return require('./emotion-1f844f16.js'); });
          ...
          case 11:
            _context2.next = 13;
            return Promise.resolve().then(function () { return require('./material-ui-bdc56e49.js'); });
          ...
          case 15:
            _context2.next = 17;
            return Promise.resolve().then(function () { return require('./styled-components-b09e7d7e.js'); });
          ...
          case 19:
            _context2.next = 21;
            return Promise.resolve().then(function () { return require('./default-93cd918f.js'); });
...
function _render() {
  _render = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(file, props) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            cachePath = path__default['default'].join(cwd, ssrConfig.distDir, "".concat(pageId, ".html"));
          ...
          case 9:
            ...
            html = (0, _context5.t0)( /*#__PURE__*/React__default['default'].createElement(DocumentContext.Provider, {
              value: /*#__PURE__*/React__default['default'].createElement(AppComponent, _extends({
                children: Page
              }, props))
          ...
          case 18:
            ...
            if (isProd() && !existsSync(cachePath)) {
              viewPath = slice$3(_context3 = slash__default['default'](file.replace(path__default['default'].join(cwd, ssrConfig.viewsDir), '').replace(ext, ''))).call(_context3, 1);

              if (includes(_context4 = ssrConfig.staticViews).call(_context4, viewPath)) {
...
var register = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(app) {
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            renderFile = /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(file, options, cb) {
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 3:
                        ...
                        pattern = map(cacheablePages).call(cacheablePages, function (page) {
                          return '^' + escaperegexp(page);
                        }).join('|');
                        moduleDetectRegEx = new RegExp(pattern);

                      case 6:
                        options.settings, options.cache, options._locals, props = _objectWithoutProperties(options, ["settings", "cache", "_locals"]);
                        _context2.prev = 7;
                        _context2.t0 = cb;
                      ...
                      case 19:
                        ...
                        if (process.env.NODE_ENV !== 'production') {
                          forEach(_context = keys(require.cache)).call(_context, function (filename) {
            ...
            _context3.next = 8;
            return Promise.resolve().then(function () { return require('./production-1c49d2ff.js'); });
          ...
          case 12:
            _context3.next = 14;
            return Promise.resolve().then(function () { return require('./development-d1973afe.js'); });
