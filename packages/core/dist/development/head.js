...
var slice_1 = function (it) {
  var own = it.slice;
  return it === ArrayPrototype$3 || (it instanceof Array && own === ArrayPrototype$3.slice) ? slice$5 : own;
};
...
var reverse_1 = function (it) {
  var own = it.reverse;
  return it === ArrayPrototype$1 || (it instanceof Array && own === ArrayPrototype$1.reverse) ? reverse$2 : own;
};
...
function onlyReactElement(list, child) {
  ...
  if (child.type === React__default['default'].Fragment) {
    ...
    return concat(list).call(list, reduce(_context = React__default['default'].Children.toArray(child.props.children)).call(_context, function (fragmentList, fragmentChild) {
      if (typeof fragmentChild === 'string' || typeof fragmentChild === 'number') {
        return fragmentList;
      }

      return concat(fragmentList).call(fragmentList, fragmentChild);
    }, []));
  }

  return concat(list).call(list, child);
}
...
function unique() {
  ...
  return function (h) {
    ...
    if (h.key && typeof h.key !== 'number' && indexOf(_context2 = h.key).call(_context2, '$') > 0) {
      ...
      var key = slice$3(_context3 = h.key).call(_context3, indexOf(_context4 = h.key).call(_context4, '$') + 1);
...
function reduceComponents(headElements) {
  ...
  return map(_context5 = reverse(_context6 = filter(_context7 = concat(_context8 = reverse(_context9 = reduce(_context10 = reduce(headElements).call(headElements, function (list, headElement) {
    var headElementChildren = React__default['default'].Children.toArray(headElement.props.children);
    return concat(list).call(list, headElementChildren);
