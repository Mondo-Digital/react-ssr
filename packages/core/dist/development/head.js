...
var uncurryThis = functionBindNative && bind$8.bind(call$2, call$2);
...
var functionApply = typeof Reflect == 'object' && Reflect.apply || (functionBindNative ? call$1.bind(apply) : function () {
...
var concat$3 = function (it) {
  var own = it.concat;
  return it === ArrayPrototype$7 || (objectIsPrototypeOf(ArrayPrototype$7, it) && own === ArrayPrototype$7.concat) ? concat$4 : own;
};
...
var collection = function (CONSTRUCTOR_NAME, wrapper, common) {
  ...
  if (!descriptors || !isCallable(NativeConstructor)
    ...
    IS_WEAK || defineProperty$8(Prototype, 'size', {
      configurable: true,
      get: function () {
...
var indexOf$2 = function (it) {
  var own = it.indexOf;
  return it === ArrayPrototype$4 || (objectIsPrototypeOf(ArrayPrototype$4, it) && own === ArrayPrototype$4.indexOf) ? indexOf$3 : own;
};
...
var reverse$2 = function (it) {
  var own = it.reverse;
  return it === ArrayPrototype$1 || (objectIsPrototypeOf(ArrayPrototype$1, it) && own === ArrayPrototype$1.reverse) ? reverse$3 : own;
};
...
var _assertThisInitialized = /*@__PURE__*/unwrapExports(assertThisInitialized);
...
function onlyReactElement(list, child) {
  ...
  if (child.type === React__default["default"].Fragment) {
    ...
    return concat$1(list).call(list, reduce(_context = React__default["default"].Children.toArray(child.props.children)).call(_context, function (fragmentList, fragmentChild) {
      if (typeof fragmentChild === 'string' || typeof fragmentChild === 'number') {
        return fragmentList;
      }

      return concat$1(fragmentList).call(fragmentList, fragmentChild);
    }, []));
  }

  return concat$1(list).call(list, child);
}
...
function unique() {
  ...
  return function (h) {
    ...
    if (h.key && typeof h.key !== 'number' && indexOf(_context2 = h.key).call(_context2, '$') > 0) {
      var _context3, _context4;

      var key = slice$4(_context3 = h.key).call(_context3, indexOf(_context4 = h.key).call(_context4, '$') + 1);
      ...
      case 'meta':
        for (var i = 0, len = METATYPES.length; i < len; i++) {
          ...
          if (_metatype === 'charSet') {
            ...
            var categories = metaCategories[_metatype] || new set();
...
function reduceComponents(headElements) {
  ...
  return map(_context5 = reverse(_context6 = filter(_context7 = concat$1(_context8 = reverse(_context9 = reduce(_context10 = reduce(headElements).call(headElements, function (list, headElement) {
    var headElementChildren = React__default["default"].Children.toArray(headElement.props.children);
    return concat$1(list).call(list, headElementChildren);
