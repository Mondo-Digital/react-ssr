...
var slice_1 = function (it) {
  var own = it.slice;
  return it === ArrayPrototype$2 || (it instanceof Array && own === ArrayPrototype$2.slice) ? slice$4 : own;
};
        ...
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            for (i = 0; i < entryPages.length; i++) {
              ...
              memfs.writeFileSync(path__default['default'].join(cwd$1, 'react-ssr-src', dir, concat(_context = "entry-".concat(name)).call(_context, ext)), template.replace('__REACT_SSR_APP__', slash__default['default'](appPath)).replace('__REACT_SSR_PAGE__', slash__default['default'](page)));
              entry[getPageId(page, '_')] = concat(_context2 = concat(_context3 = "./react-ssr-src/".concat(slash__default['default'](dir), "/entry-")).call(_context3, name)).call(_context2, ext);
            }
        ...
        case 3:
          ...
          return new promise(function (resolve, reject) {
            compiler.run(function (err, stats) {
              ...
              console.log(concat(_context = "Done. ".concat(entryPages.length, " pages build into ")).call(_context, ssrConfig.distDir));
              resolve();
            });
          });
