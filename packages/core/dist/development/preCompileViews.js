...
var defineGlobalProperty = function (key, value) {
  try {
    defineProperty$9(global_1, key, { value: value, configurable: true, writable: true });
  } catch (error) {
    global_1[key] = value;
  } return value;
};
...
var slice$8 = entryVirtual('Array').slice;

var ArrayPrototype$4 = Array.prototype;

var slice$7 = function (it) {
  var own = it.slice;
  return it === ArrayPrototype$4 || (objectIsPrototypeOf(ArrayPrototype$4, it) && own === ArrayPrototype$4.slice) ? slice$8 : own;
};
...
if (!queueMicrotask) {
  ...
  // environments with maybe non-completely correct, but existent Promise
    ...
    then = functionBindContext(promise$7.then, promise$7);
    notify$1 = function () {
      then(flush);
    };
...
var promise$6 = path.Promise;

var promise$5 = promise$6;
...
var _asyncToGenerator = /*@__PURE__*/unwrapExports(asyncToGenerator);
...
var forEach$6 = entryVirtual('Array').forEach;
...
var forEach$4 = function (it) {
  ...
  return it === ArrayPrototype$2 || (objectIsPrototypeOf(ArrayPrototype$2, it) && own === ArrayPrototype$2.forEach)
    || hasOwnProperty_1(DOMIterables, classof(it)) ? forEach$5 : own;
};
...
var reverse$5 = function (it) {
  var own = it.reverse;
  return it === ArrayPrototype$1 || (objectIsPrototypeOf(ArrayPrototype$1, it) && own === ArrayPrototype$1.reverse) ? reverse$6 : own;
};
...
function _regeneratorRuntime() {
  ...
  function define(obj, key, value) {
    return defineProperty$1(obj, key, {
      value: value,
      enumerable: !0,
      configurable: !0,
      writable: !0
  ...
  function defineIteratorMethods(prototype) {
    ...
    forEach(_context = ["next", "throw", "return"]).call(_context, function (method) {
  ...
  function Context(tryLocsList) {
    this.tryEntries = [{
      tryLoc: "root"
    }], forEach(tryLocsList).call(tryLocsList, pushTryEntry, this), this.reset(!0);
  }
  ...
  return GeneratorFunction.prototype = GeneratorFunctionPrototype, define(Gp, "constructor", GeneratorFunctionPrototype), define(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, toStringTagSymbol, "GeneratorFunction"), exports.isGeneratorFunction = function (genFun) {
    ...
    return setPrototypeOf ? setPrototypeOf(genFun, GeneratorFunctionPrototype) : (genFun.__proto__ = GeneratorFunctionPrototype, define(genFun, toStringTagSymbol, "GeneratorFunction")), genFun.prototype = create(Gp), genFun;
    ...
    void 0 === PromiseImpl && (PromiseImpl = promise$1);
    ...
    reset: function reset(skipTempReset) {
      ...
      if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, forEach(_context2 = this.tryEntries).call(_context2, resetTryEntry), !skipTempReset) for (var name in this) {
        "t" === name.charAt(0) && hasOwn.call(this, name) && !isNaN(+slice$2(name).call(name, 1)) && (this[name] = undefined);
      }
    },
    stop: function stop() {
      this.done = !0;
...
var concat$3 = function (it) {
  var own = it.concat;
  return it === ArrayPrototype || (objectIsPrototypeOf(ArrayPrototype, it) && own === ArrayPrototype.concat) ? concat$4 : own;
};
...
var _toArray = /*@__PURE__*/unwrapExports(toArray);
...
var startsWith$3 = entryVirtual('String').startsWith;
...
var startsWith$2 = function (it) {
  ...
  return typeof it == 'string' || it === StringPrototype$1
    || (objectIsPrototypeOf(StringPrototype$1, it) && own === StringPrototype$1.startsWith) ? startsWith$3 : own;
};
...
var endsWith$3 = entryVirtual('String').endsWith;
...
var endsWith$2 = function (it) {
  ...
  return typeof it == 'string' || it === StringPrototype
    || (objectIsPrototypeOf(StringPrototype, it) && own === StringPrototype.endsWith) ? endsWith$3 : own;
};

var endsWith$1 = endsWith$2;

var endsWith = endsWith$1;

var slice = slice$6;

var cwd$3 = process.cwd();

var debug = require('debug')('REACT-SSR:src/helpers');
...
var getSsrConfig = function getSsrConfig() {
  ...
  var ssrConfigPath = path__default["default"].join(cwd$3, 'ssr.config.js');

  if (existsSync(ssrConfigPath)) {
    return assign(defaultConfig, require(ssrConfigPath));
  } else {
...
var getEngine = function getEngine() {
  return existsSync(path__default["default"].join(cwd$3, 'tsconfig.json')) ? 'tsx' : 'jsx';
};
...
var getPages = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
    ...
    var possibles, pages, i, _context, _context2, possible, name, _context3;
    ...
    return regenerator.wrap(function _callee$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return readdir__default["default"](path__default["default"].join(cwd$3, ssrConfig.viewsDir));

          case 2:
            possibles = _context5.sent;
            pages = [];
            i = 0;
          ...
          case 5:
            ...
            if (!(startsWith(_context = name.toLowerCase()).call(_context, '_app') || startsWith(_context2 = name.toLowerCase()).call(_context2, '_document'))) {
              _context5.next = 10;
              break;
            }
          ...
          case 10:
            if (endsWith(possible).call(possible, '.jsx') || endsWith(possible).call(possible, '.tsx')) {
              if (!isProd() && ssrConfig.beta) {
                if (ssrConfig.betaOpts.viewsRegex.test(possible)) {
                  debug(concat$1(_context3 = "BETA: Adding page: ".concat(possible, ". Matching: ")).call(_context3, ssrConfig.betaOpts.viewsRegex.toString()));
                  pages.push(possible);
                }
              } else {
                debug("Adding page: ".concat(possible));
                pages.push(possible);
              }
            }
          ...
          case 14:
            debug(concat$1(_context4 = "Found ".concat(pages.length, " pages ")).call(_context4, ssrConfig.beta ? "matching ".concat(ssrConfig.betaOpts.viewsRegex.toString()) : '', "."));
...
var getPageId = function getPageId(page) {
  ...
  var _page$replace$replace = page.replace(path__default["default"].join(cwd$3, ssrConfig.viewsDir), '').replace(path__default["default"].extname(page), '').split(path__default["default"].sep),
      _page$replace$replace2 = _toArray(_page$replace$replace),
      rest = slice(_page$replace$replace2).call(_page$replace$replace2, 1);
...
var getBabelrc = function getBabelrc() {
  if (existsSync(path__default["default"].join(cwd$2, '.babelrc'))) return path__default["default"].join(cwd$2, '.babelrc');
  if (existsSync(path__default["default"].join(cwd$2, '.babelrc.js'))) return path__default["default"].join(cwd$2, '.babelrc.js');
  if (existsSync(path__default["default"].join(cwd$2, 'babel.config.js'))) return path__default["default"].join(cwd$2, 'babel.config.js');
...
var configureWebpack = function configureWebpack(entry) {
  var config = {
    ...
    entry: entry,
    output: {
      path: path__default["default"].join(cwd$2, ssrConfig.distDir),
      filename: '[name].js'
    },
    resolve: {
    ...
    module: {
      rules: [{
        ...
        use: [{
          ...
          options: {
            publicPath: path__default["default"].join(cwd$2, ssrConfig.distDir),
            hmr: !isProd(),
            reloadAll: true
          }
        }, {
...
var getEntry = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(memfs) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            entryPath = path__default["default"].resolve(__dirname, "../../lib/webpack/".concat(ssrConfig.id, ".js"));
            template = fse__default["default"].readFileSync(entryPath).toString();
            appPath = path__default["default"].join(__dirname, 'app.js');

            if (fse__default["default"].existsSync(path__default["default"].join(cwd$1, ssrConfig.viewsDir, "_app".concat(ext)))) {
              appPath = path__default["default"].join(cwd$1, ssrConfig.viewsDir, "_app".concat(ext));
            }
            ...
            for (i = 0; i < entryPages.length; i++) {
              ...
              memfs.writeFileSync(path__default["default"].join(cwd$1, 'react-ssr-src', dir, concat$1(_context = "entry-".concat(name)).call(_context, ext)), template.replace('__REACT_SSR_APP__', slash__default["default"](appPath)).replace('__REACT_SSR_PAGE__', slash__default["default"](page)));
              entry[getPageId(page, '_')] = concat$1(_context2 = concat$1(_context3 = "./react-ssr-src/".concat(slash__default["default"](dir), "/entry-")).call(_context3, name)).call(_context2, ext);
            }
...
var preCompileViews = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
  ...
  return regenerator.wrap(function _callee$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          fse__default["default"].removeSync(path__default["default"].join(cwd, ssrConfig.distDir));
          _context2.next = 3;
          return getEntry(memfs);

        case 3:
          _yield$getEntry = _context2.sent;
          _yield$getEntry2 = _slicedToArray(_yield$getEntry, 2);
          entry = _yield$getEntry2[0];
          entryPages = _yield$getEntry2[1];
          webpackConfig = configureWebpack(entry);
          ...
          return new promise(function (resolve, reject) {
            compiler.run(function (err, stats) {
              ...
              console.log(concat$1(_context = "Done. ".concat(entryPages.length, " pages build into ")).call(_context, ssrConfig.distDir));
              resolve();
            });
          });
...
module.exports = preCompileViews;
