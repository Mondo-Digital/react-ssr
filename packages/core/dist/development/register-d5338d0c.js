...
var uncurryThis = functionBindNative && bind$9.bind(call$1, call$1);
...
var bind$8 = functionUncurryThis(functionUncurryThis.bind);

// optional / simple context binding
var functionBindContext = function (fn, that) {
  aCallable(fn);
  return that === undefined ? fn : functionBindNative ? bind$8(fn, that) : function (/* ...args */) {
...
var isArrayIteratorMethod = function (it) {
  return it !== undefined && (iterators.Array === it || ArrayPrototype$7[ITERATOR$4] === it);
};
...
if (!isCallable(IteratorPrototype$1[ITERATOR$2])) {
  defineBuiltIn(IteratorPrototype$1, ITERATOR$2, function () {
    return this;
  });
}
...
if (!queueMicrotask) {
  ...
  // environments with maybe non-completely correct, but existent Promise
    ...
    then = functionBindContext(promise$6.then, promise$6);
    notify$1 = function () {
      then(flush);
    };
...
var forEach$7 = entryVirtual('Array').forEach;

var forEach$6 = forEach$7;
...
var forEach$5 = function (it) {
  var own = it.forEach;
  return it === ArrayPrototype$6 || (objectIsPrototypeOf(ArrayPrototype$6, it) && own === ArrayPrototype$6.forEach)
    || hasOwnProperty_1(DOMIterables, classof(it)) ? forEach$6 : own;
};
...
var reverse$5 = function (it) {
  var own = it.reverse;
  return it === ArrayPrototype$5 || (objectIsPrototypeOf(ArrayPrototype$5, it) && own === ArrayPrototype$5.reverse) ? reverse$6 : own;
};
...
function _regeneratorRuntime() {
  ...
  function defineIteratorMethods(prototype) {
    ...
    forEach$1(_context = ["next", "throw", "return"]).call(_context, function (method) {
  ...
  function Context(tryLocsList) {
    this.tryEntries = [{
      tryLoc: "root"
    }], forEach$1(tryLocsList).call(tryLocsList, pushTryEntry, this), this.reset(!0);
  }
  ...
  return GeneratorFunction.prototype = GeneratorFunctionPrototype, define(Gp, "constructor", GeneratorFunctionPrototype), define(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, toStringTagSymbol, "GeneratorFunction"), exports.isGeneratorFunction = function (genFun) {
    ...
    return setPrototypeOf$1 ? setPrototypeOf$1(genFun, GeneratorFunctionPrototype) : (genFun.__proto__ = GeneratorFunctionPrototype, define(genFun, toStringTagSymbol, "GeneratorFunction")), genFun.prototype = create(Gp), genFun;
    ...
    reset: function reset(skipTempReset) {
      ...
      if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, forEach$1(_context2 = this.tryEntries).call(_context2, resetTryEntry), !skipTempReset) for (var name in this) {
...
var map$2 = function (it) {
  var own = it.map;
  return it === ArrayPrototype$3 || (objectIsPrototypeOf(ArrayPrototype$3, it) && own === ArrayPrototype$3.map) ? map$3 : own;
};
...
var objectAssign = !$assign || fails(function () {
  ...
  while (argumentsLength > index) {
    ...
    var keys = getOwnPropertySymbols ? concat$5(objectKeys(S), getOwnPropertySymbols(S)) : objectKeys(S);
    var length = keys.length;
    var j = 0;
    var key;
    while (length > j) {
...
var assign$6 = path.Object.assign;

var assign$5 = assign$6;
...
var bind$5 = function (it) {
  var own = it.bind;
  return it === FunctionPrototype || (objectIsPrototypeOf(FunctionPrototype, it) && own === FunctionPrototype.bind) ? bind$6 : own;
};
...
function _extends() {
  ...
  module.exports = _extends = assign$1 ? bind(_context = assign$1).call(_context) : function (target) {
...
var filter$2 = function (it) {
  var own = it.filter;
  return it === ArrayPrototype$2 || (objectIsPrototypeOf(ArrayPrototype$2, it) && own === ArrayPrototype$2.filter) ? filter$3 : own;
};
...
var includes$2 = function (it) {
  var own = it.includes;
  if (it === ArrayPrototype$1 || (objectIsPrototypeOf(ArrayPrototype$1, it) && own === ArrayPrototype$1.includes)) return includes$4;
  if (typeof it == 'string' || it === StringPrototype$2 || (objectIsPrototypeOf(StringPrototype$2, it) && own === StringPrototype$2.includes)) {
    return includes$3;
  } return own;
};
...
function _inherits(subClass, superClass) {
  ...
  defineProperty$1(subClass, "prototype", {
    writable: false
  });
...
var concat$2 = function (it) {
  var own = it.concat;
  return it === ArrayPrototype || (objectIsPrototypeOf(ArrayPrototype, it) && own === ArrayPrototype.concat) ? concat$3 : own;
};
    ...
    return regenerator.wrap(function _callee$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
            ...
            if (endsWith(possible).call(possible, '.jsx') || endsWith(possible).call(possible, '.tsx')) {
              if (!isProd() && ssrConfig.beta) {
                if (ssrConfig.betaOpts.viewsRegex.test(possible)) {
                  debug(concat(_context3 = "BETA: Adding page: ".concat(possible, ". Matching: ")).call(_context3, ssrConfig.betaOpts.viewsRegex.toString()));
                  pages.push(possible);
                }
              } else {
          ...
          case 14:
            debug(concat(_context4 = "Found ".concat(pages.length, " pages ")).call(_context4, ssrConfig.beta ? "matching ".concat(ssrConfig.betaOpts.viewsRegex.toString()) : '', "."));
...
var getPageId = function getPageId(page) {
  ...
  var _page$replace$replace = page.replace(path__default["default"].join(cwd$1, ssrConfig.viewsDir), '').replace(path__default["default"].extname(page), '').split(path__default["default"].sep),
      ...
      rest = slice$1(_page$replace$replace2).call(_page$replace$replace2, 1);
...
var ignoreDotDir = function ignoreDotDir(file, stats) {
  ...
  return stats.isDirectory() && startsWith(_context6 = path__default["default"].basename(file)).call(_context6, '.');
};
    ...
    return regenerator.wrap(function _callee2$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            return _context8.abrupt("return", readdir__default["default"](cwd$1, concat(_context7 = [ignoreNodeModules, ignoreDotDir]).call(_context7, ignores)));
    ...
    return regenerator.wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _context2.next = 5;
            return Promise.resolve().then(function () { return require('./antd-2b11333d.js'); });
          ...
          case 7:
            _context2.next = 9;
            return Promise.resolve().then(function () { return require('./emotion-c36b241c.js'); });
          ...
          case 11:
            _context2.next = 13;
            return Promise.resolve().then(function () { return require('./material-ui-2193a93f.js'); });
          ...
          case 15:
            _context2.next = 17;
            return Promise.resolve().then(function () { return require('./styled-components-90c1b029.js'); });
          ...
          case 19:
            _context2.next = 21;
            return Promise.resolve().then(function () { return require('./default-4c9c5516.js'); });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 18:
            ...
            if (isProd() && !existsSync(cachePath)) {
              viewPath = slice$1(_context3 = slash__default["default"](file.replace(path__default["default"].join(cwd, ssrConfig.viewsDir), '').replace(ext, ''))).call(_context3, 1);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 8;
            return Promise.resolve().then(function () { return require('./production-d25b9fee.js'); });
          ...
          case 12:
            _context3.next = 14;
            return Promise.resolve().then(function () { return require('./development-69b2bd5b.js'); });
